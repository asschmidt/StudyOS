...
.extern _stage2_segment                 /* Segement Address of the Stage 2 Bootloader Code + Data */
.extern _stage2_size                    /* Length of the Stage 2 Bootloader Code Segment */

.extern _stage2_stack_segment           /* Segment Address for the Bootloader Stage 2 Stack Memory */
.extern _stage2_stack_start_offset      /* Offset Address for the Bootloader Stage 2 Stack Memory */
.extern _stage2_stack_size              /* Size of the Stack Memory Segment for Stage 2 Bootloader */

.extern _stage2_ram_segment             /* Segment Address for the Bootloader Stage 2 RAM */
.extern _stage2_ram_offset              /* Offset Address for the Bootloader Stage 2 RAM */
.extern _stage2_ram_size                /* Size of the RAM Segment for Stage 2 Bootloader */
...
stage2Start:
    ...
    mov ax, OFFSET _stage2_ram_segment    /* Get the segment for the RAM of bootloader stage 2 */
    mov es, ax              		      /* Initialize the Extra Segement to _boot_ram_segment */

	mov ax, OFFSET _stage2_segment        /* Get the segment for the bootloader stage 2 */
	mov ds, ax              		      /* Initialize the DataSegement to _boot_stage2_segment */

    mov ax, OFFSET _stage2_stack_segment  /* Initialize AX to the Stack Segment */
    mov ss, ax              		      /* Initialize the Stack Segement to _boot_stack_segment */

    /* At this point we have the following segment configuration
     *
     * CS: 0x07E0 (_stage2_segment)
     * ES: 0x7D00 (_stage2_ram_segment)
     * DS: 0x07E0 (_stage2_segment)
     * SS: 0x7F00 (_stage2_stack_segment)
     */

	/* Initialize the Stack Pointer */
    mov sp, OFFSET _stage2_stack_start_offset
